...
This report records the pre-migration review and proposals. Step 1 is now implemented in `ts/AGENTS.md` and `ts/react.md`; see [README.md](README.md) for adoption and the selected defaults. `TODO.md` retains the original notes. Formatter configs, skill installation, and changes to other projects remain later steps.
